...
function showUserMsg(msg) {
  const fullMsg = { ...msg, id: Date.now() }
  console.log('emitting show-user-msg:', fullMsg)
  eventBusService.emit('show-user-msg', fullMsg)
}
...
// })
// setInterval(() => {
//   eventBusService.emit('some-event', { num: 1234 })
// }, 1000)
